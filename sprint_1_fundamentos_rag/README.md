...
| **04** | 17/09 (Qui) | Prática/Código | [Structured Outputs com Pydantic & Modelo Flash Gemini](file:///home/eduardo/facul/8_semestre/grupo_estudos_ia/sprint_1_fundamentos_rag/dia_04_structured_outputs_validacao.md) | Leitura Google AI Docs / Pydantic, JSON schemas estritos, parser de incidentes |
...
| **07** | 22/09 (Ter) | Palestra + Projeto | [Conversa com Ramon Lummertz & Ingestão com Chunking no ChromaDB](file:///home/eduardo/facul/8_semestre/grupo_estudos_ia/sprint_1_fundamentos_rag/dia_07_ingestao_chunking_embeddings.md) | **14h-15h: Palestra Online com Ramon Lummertz**; 15h-17h: Ingestão de PDFs e Chunking com ChromaDB |
