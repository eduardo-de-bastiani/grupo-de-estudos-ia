...
| **04** | 17/09 (Qui) | Prática/Código | [Structured Outputs com Pydantic & Modelo Flash Gemini](dia_04_structured_outputs_validacao.md) | Leitura Google AI Docs / Pydantic, JSON schemas estritos, parser de incidentes |
...
3. Recebe perguntas em linguagem natural, recupera os trechos mais relevantes por similaridade semântica e gera respostas precisas utilizando o **Modelo Flash Gemini**.
