...
| **02** | 15/09 (Ter) | Plataforma | [Explorando o Google AI Studio: Playground, Tools & Compare Mode](dia_02_explorando_google_ai_studio.md) | Imersão no Google AI Studio, chaves de API, parâmetros (Temp, Top-P, Top-K, Thinking), Tools nativas, Safety Settings e Compare Mode |
...
| **06** | 21/09 (Seg) | Projeto (Kickoff) | [Kickoff do AskData, Coleta de Documentos & Setup Git](dia_06_kickoff_projeto_arquitetura_rag.md) | Leitura RAG, escolha de domínio e coleta ativa de documentos reais (PDFs/MDs), setup do Git e dinâmica piloto/copiloto |
...
3. Recebe perguntas em linguagem natural, recupera os trechos mais relevantes por similaridade semântica e gera respostas precisas utilizando o **Modelo Gemini**.
