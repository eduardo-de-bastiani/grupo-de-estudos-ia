...
Cada trio terá **15 minutos rigorosamente cronometrados**:
* **10 minutos de Apresentação & Live Demo:**
  * Contexto do problema e domínio de documentos escolhido.
  * Arquitetura técnica (pipeline de ingestão, chunking, ChromaDB e prompt blindado).
